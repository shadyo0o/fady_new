...
/**
 * Format vaccine warnings for consistent display
 * Ensures warnings are properly structured across all pages
 * @param {Array} vaccines - Array of vaccine objects
 * @returns {Array} - Formatted warnings with title and description
 */
